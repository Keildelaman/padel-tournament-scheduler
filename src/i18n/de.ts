...
export const de: TranslationMap = {
  ...
  // Scout
  'nav.scout': 'Scout',
  'scout.title': 'Turnier-Scout',
  'scout.description': 'Analysiere deine Gegner bei padel-austria.at Turnieren. Gib deinen Namen ein und w\u00e4hle ein Turnier.',
  'scout.placeholder': 'Name eingeben (z.B. Manuel Keilman) oder Turnier-URL...',
  'scout.loadBtn': 'Laden',
  'scout.loading': 'Laden...',
  'scout.clear': 'Leeren',
  'scout.loadingTournament': 'Turnierdaten werden geladen...',
  'scout.loadingPlayers': 'Spielerprofile werden geladen... ({loaded}/{total})',
  'scout.teamsTitle': 'Teams',
  'scout.matches': 'Spiele',
  'scout.winRateShort': 'Winrate',
  'scout.matchesLabel': 'Spiele',
  'scout.winRateLabel': 'Winrate',
  'scout.record': 'Bilanz',
  'scout.points': 'Punkte',
  'scout.ranking': 'Rang',
  'scout.recentTournaments': 'Letzte Turniere',
  'scout.threatLow': 'Niedrig',
  'scout.threatMedium': 'Mittel',
  'scout.threatHigh': 'Stark',
  'scout.avgWinRate': 'Avg. Winrate',
  'scout.avgMatches': 'Avg. Spiele',
  'scout.maxMatches': 'Max. Spiele',
  'scout.noExperience': 'Ohne Erfahrung',
  'scout.loadingProfile': 'Spielerprofil wird geladen...',
  'scout.viewProfile': 'Profil ansehen',
  'scout.upcomingTournaments': 'Bevorstehende Turniere',
  'scout.noUpcoming': 'Keine bevorstehenden Turniere gefunden.',
  'scout.scoutBtn': 'Scouten',
  'scout.backToProfile': '\u2190 Zur\u00fcck zu {name}',
